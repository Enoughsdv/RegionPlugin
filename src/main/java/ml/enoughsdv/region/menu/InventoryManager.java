...
import ml.enoughsdv.region.menu.opener.ChestInventoryOpener;
import ml.enoughsdv.region.menu.opener.InventoryOpener;
import ml.enoughsdv.region.menu.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    public void init() {
        ...
        new InvTask().runTaskTimer(plugin, 10L, 10L);
    }
